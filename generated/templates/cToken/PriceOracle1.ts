...
export class PriceOracle1__anchorsResult {
  value0: BigInt;
  value1: BigInt;
...
export class PriceOracle1 extends ethereum.SmartContract {
  static bind(address: Address): PriceOracle1 {
    return new PriceOracle1("PriceOracle1", address);
  }
  ...
  anchors(param0: Address): PriceOracle1__anchorsResult {
    let result = super.call("anchors", "anchors(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);

    return new PriceOracle1__anchorsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_anchors(
    param0: Address
  ): ethereum.CallResult<PriceOracle1__anchorsResult> {
    let result = super.tryCall(
      "anchors",
    ...
    return ethereum.CallResult.fromValue(
      new PriceOracle1__anchorsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
