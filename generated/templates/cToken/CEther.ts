...
export class CEther__getAccountSnapshotResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class CEther extends ethereum.SmartContract {
  static bind(address: Address): CEther {
    return new CEther("CEther", address);
  }
  ...
  getAccountSnapshot(account: Address): CEther__getAccountSnapshotResult {
    let result = super.call(
      "getAccountSnapshot",
    ...
    return new CEther__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getAccountSnapshot(
    account: Address
  ): ethereum.CallResult<CEther__getAccountSnapshotResult> {
    let result = super.tryCall(
      "getAccountSnapshot",
      "getAccountSnapshot(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new CEther__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
